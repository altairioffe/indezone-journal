...
export default function Level1(props) {
  ...
  return (
    <section>
      ...
      <img
        src="images/lessons/brainsley-01.png"
        className={classes.image}
      />
      <img
        src="images/lessons/brainsley-02.png"
        className={classes.image}
      />
      <img
        src="images/lessons/brainsley-03.png"
        className={classes.image}
      />
      <img
        src="images/lessons/brainsley-04.png"
        className={classes.image}
      />
      <img
        src="images/lessons/brainsley-05.png"
        className={classes.image}
      />
      <img
        src="images/lessons/brainsley-06.png"
        className={classes.image}
      />
      <img
        src="images/lessons/brainsley-07.png"
        className={classes.image}
      />
      <img
        src="images/lessons/brainsley-08.png"
        className={classes.image}
      />
          </Carousel>
      </div>
