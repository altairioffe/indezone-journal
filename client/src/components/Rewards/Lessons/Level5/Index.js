...
export default function Level1(props) {
  ...
  return (
    <section>
      ...
      <img
        src="images/lessons/lesson-5-01.png"
        className={classes.image}
      />
      <img
        src="images/lessons/lesson-5-02.png"
        className={classes.image}
      />
      <img
        src="images/lessons/lesson-5-03.png"
        className={classes.image}
      />
      <img
        src="images/lessons/lesson-5-04.png"
        className={classes.image}
      />
      <img
        src="images/lessons/lesson-5-05.png"
        className={classes.image}
      />
          </Carousel>
      </div>
